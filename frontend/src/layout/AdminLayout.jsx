// layout/AdminLayout.jsx - Updated with authentication and logout functionality
...
export default function AdminLayout() {
  ...
  const { user, logout, loading, isAuthenticated, isAdmin } = useAuth(); // Use AuthContext
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-300 mb-4">Admin privileges required</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col">
      ...
      {/* Main layout container - flex-1 to take remaining space */}
